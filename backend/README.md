...
## Project Structure
    ...
    ├── testapiautoconnecto_87601  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_87601`
...
2. Clone this repo and `cd testapiautoconnecto_87601`
